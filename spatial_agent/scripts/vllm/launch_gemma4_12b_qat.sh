...
SERVED_NAME="gemma-4-12b-it-qat"
MAX_MODEL_LEN=65536  # 128K context
MAX_NUM_SEQS=64   # Concurrency=1 workload: minimize graph-capture pressure
# Gemma 4 12B fits well on a single GPU but TP_SIZE should match GPUs for standard cluster scripts
TP_SIZE=8

#=============================================================================
# SLURM Configuration
#=============================================================================
JOB_NAME="vllm-gemma4-12b-qat"
...
USAGE:
    bash spatial_agent/scripts/vllm/launch_gemma4_12b_qat.sh
...
MONITORING:
    ...
    - Logs: tail -f logs/slurm_vllm/vllm-gemma4-12b-qat_<job_id>.out
